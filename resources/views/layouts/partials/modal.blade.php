<x-modal name="file-detail-modal" :show="$errors->userDeletion->isNotEmpty()" focusable>
    ...
    <div x-data="{
        ...
        @set-file.window="file=$event.detail;">
            ...
            <form class="space-y-4" :action="updateUrl" method="POST">
                ...
                <div>
                    <label for="fileName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">File
                        Name</label>
                    <input name="name" x-model="file.name"
                ...
                <div>
                    ...
                    <input name="size" x-model="file.size"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                ...
                <div>
                    ...
                    <input name="type" x-model="file.type"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        readonly placeholder="" />
                </div>
                <div>
                    <label for="fileDate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload
                        date
                    </label>
                    <input name="date" x-model="file.created_at"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        readonly placeholder="" />
                </div>
                <button type="submit"
